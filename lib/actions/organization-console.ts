    ...
    const checklist = [
      {
        ...
        href: '/dashboard/settings/organization-console/import-center',
        cta: totalContacts > 0 ? 'Review' : 'Import',
      },
      {
        key: 'review-duplicates',
        label: 'Review duplicate contacts',
        done: duplicatePending === 0,
        href: '/dashboard/crm/duplicates',
        cta: duplicatePending === 0 ? 'Review' : 'Resolve',
      },
      {
        key: 'configure-tiers',
        label: 'Configure membership tiers',
        done: tierCount > 0,
        href: '/dashboard/settings#tiers',
        cta: tierCount > 0 ? 'Manage' : 'Add Tier',
      },
      {
        key: 'branding',
        label: 'Set organization branding/logo',
      ...
      },
      {
        ...
        done: integrationCount > 0 || apiKeys > 0,
        href: apiKeys > 0 ? '/dashboard/integrations' : '/dashboard/settings/api-keys',
        cta: apiKeys > 0 ? 'Open' : 'Create Key',
      },
      {
        key: 'first-event',
        label: 'Create first event',
        done: eventCount > 0,
        href: eventCount > 0 ? '/dashboard/events' : '/dashboard/events/new',
        cta: eventCount > 0 ? 'Review' : 'Create',
      },
      {
        key: 'historical-import',
        label: 'Import historical data',
        done: totalContacts > 10,
        href: '/dashboard/settings/organization-console/import-center',
        cta: 'Import',
      },
      {
      ...
      {
        key: 'fundraising',
        label: 'Create fundraising campaign',
        done: campaigns > 0,
        href: campaigns > 0 ? '/dashboard/fundraising' : '/dashboard/fundraising/new',
        cta: campaigns > 0 ? 'Review' : 'Create',
      },
    ]
