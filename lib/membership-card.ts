...
export async function generateMembershipCardQR(member: Member, organization: Organization) {
...
export async function generateAppleWalletPass(member: Member, organization: Organization) {
...
export async function generateGooglePayPass(member: Member, organization: Organization) {
