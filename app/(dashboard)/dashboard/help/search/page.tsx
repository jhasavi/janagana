...
export default async function DashboardHelpSearchPage({ searchParams }: SearchPageProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <form action="/dashboard/help/search" method="GET">
      ...
      <div>
        ...
        {results.length === 0 ? (
          ...
          <div className="space-y-4">
            {results.map((result) => (
              <Link key={result.article.id} href={`/dashboard/help/${result.article.slug}`}>
