...
import { getMembers, getEvents, getVolunteerOpportunities, getClubs } from '@/lib/actions'
...
export default function DashboardPage() {
  ...
  const loadDashboardData = async () => {
    try {
      const [members, events, volunteers, clubs] = await Promise.all([
        getMembers(),
        getEvents(),
      ...
      setVolunteerCount((volunteers as any[]).length)
      setClubCount((clubs as any[]).length)
    } catch (error) {
